                    ...
                    <br/><br/>
                      <div class="row offset-1"><!-- Content Row -->
                        ...
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="first_name" id="first_name" type="text"  required="required" data-validation-required-message="Please enter your first name.">
                        ...
                        <div class="col-md-3">  
                            ...
                            <input class="form-control" name="middle_name" id="middle_name" type="text"  required="required" data-validation-required-message="Please enter your middle name.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="last_name" id="last_name" type="text"  required="required" data-validation-required-message="Please enter your last name.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                      ...
                      <div class="row offset-1"><!-- Content Row -->
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="purpose_of_txn"  id="purpose_of_txn" type="text"  required="required" data-validation-required-message="Please enter the purpose of transaction">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="occupation"  id="occupation" type="text"  required="required" data-validation-required-message="Please enter your occupation.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="issued_id_number"  id="issued_id_number" type="tel"  required="required" data-validation-required-message="Please enter your phone number.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>    
                      </div><!-- end of content row -->
                      <div class="row offset-1"><!-- Content Row --> 
                        <div class="col-md-9">
                            ...
                            <input class="form-control" name="present_address"  id="present_address" type="tel"  required="required" data-validation-required-message="Please enter your present address.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>              
                        <div class="col-md-9">
                            ...
                            <input class="form-control" name="permanent_address"  id="permanent_address" type="text"   required="required" data-validation-required-message="Please enter your permanent address.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                      </div><!-- end of content row -->
                      <div class="row offset-1"><!-- Content Row -->
                        <div class="col-md-2">
                            ...
                            <input class="form-control" name="civil_status"  id="civil_status" type="text"  required="required" data-validation-required-message="Please enter your civil status.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <input class="form-control" name="nationality"  id="nationality" type="text"  required="required" data-validation-required-message="Please enter your nationality.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-2">
                            ...
                            <input class="form-control" name="birthdate" id="birthdate" type="text"   required="required" data-validation-required-message="Please enter your birth date.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="birthplace"  id="birthplace" type="text"  required="required" data-validation-required-message="Please enter your place of birth.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                      </div><!-- end of content row -->
                      <div class="row offset-1"><!-- Content Row -->
                        <div class="col-md-3  ">
                            ...
                            <input class="form-control" name="fund_source"  id="fund_source" type="text"  required="required" data-validation-required-message="Please enter the source of fund.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                      ...
                      <div class="row offset-1"><!-- Content Row -->
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="contact_number"  id="contact_number" type="tel" required="required" data-validation-required-message="Please enter your contact number.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <input class="form-control" name="email_address"  id="email_address" type="text" required="required" data-validation-required-message="Please enter your email address.">
                            <p class="help-block text-danger"></p>
                            </div>
                        </div>
                        <div class="col-md-3">
                      ...
                      <div class="row offset-1"><!-- Content Row -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <input class="form-control" name="auth_1_trader_name"  id="auth_1_trader_name" type="text" required="required" data-validation-required-message="Please enter name of trader.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Position</label>
                              <input class="form-control"  name="auth_1_trader_position" id="auth_1_trader_position" type="text" required="required" data-validation-required-message="Please enter position.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Nationality</label>
                              <input class="form-control" name="auth_1_trader_nationality"  id="auth_1_trader_nationality" type="text"  required="required" data-validation-required-message="Please enter nationality.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Contact Number</label>
                              <input class="form-control" name="auth_1_trader_contact_number"  id="auth_1_trader_contact_number" type="text"  required="required" data-validation-required-message="Please enter contact.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <button class="btn btn-primary" id="btnSignatureTrader1" type="submit" onclick="Capture()">Signature</button><br/><hr/>
                              <img id='trader1signature' width="300"  height="200"   />
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-4 offset-1">
                            <div class="form-group">
                              ...
                              <input class="form-control" name="auth_2_trader_name"  id="auth_2_trader_name" type="text"  required="required" data-validation-required-message="Please enter name of trader.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Position</label><br/>
                              <input class="form-control"  name="auth_2_trader_position" id="auth_2_trader_position" type="text"  required="required" data-validation-required-message="Please enter position.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Nationality</label>
                              <input class="form-control"  name="auth_2_trader_nationality" id="auth_2_trader_nationality" type="text"  required="required" data-validation-required-message="Please enter nationality.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <label>Contact Number</label><br/>
                              <input class="form-control" name="auth_2_trader_contact_number" id="auth_2_trader_contact_number" type="text"  required="required" data-validation-required-message="Please enter contact.">
                              <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                              <button class="btn btn-primary" name="first_name"  id="btnSignatureTrader2" type="submit" onclick="signature('trader2')">Signature</button><br/><hr/>                        
                              <img id='trader2signature' width="300"  height="200"   />
                            </div>
                          </div>
                      </div>  <!-- end of content row -->
                      <div class="row offset-1"><!-- Content Row -->
